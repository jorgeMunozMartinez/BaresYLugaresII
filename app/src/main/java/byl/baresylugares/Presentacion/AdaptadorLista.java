...
public class AdaptadorLista extends RecyclerView.Adapter<AdaptadorLista.AdaptadorViewHolder>{
    ...
    public AdaptadorLista(Context context, ArrayList<Recomendacion> recomendacions) {
